...
True Type Font: Game Font 7 version 1.0


EULA
-==-
The font Game Font 7 is freeware for home use only.


DESCRIPTION
-=========-
Original thin font. Western and Cyrillic code pages are supported. The font was created special for freeware game "Android Arkanoid-7".
https://play.google.com/store/apps/details?id=com.style_7.androidarkanoid_7

Files in game_font_7.zip:
       	readme.txt     		this file;
        game_font_7.ttf 	regular font;
	game_font_7_screen.png	preview image.
